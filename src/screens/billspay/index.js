...
import {
  ...
  Button,
  Spinner,
  Input,Right,Footer,FooterTab,Card,CardItem,Thumbnail, ActionSheet
} from "native-base";
    ...
    return (
      <Container style={styles.container}>
        <Header noShadow
            ...
            <Body>
            <Text style={{color: '#4F4F4F', fontSize: 18,fontWeight: '700',}}>Categoryy</Text>
            </Body>
        ...
        <Item rounded style={styles.inputStyle}>
                <Icon active name='search' style={{color: '#828282', fontSize: 15, marginRight: 10, marginLeft:20 }}/>
                <Input placeholder='Search' placeholderTextColor="#828282"  />
              </Item>
            ...
            <ListItem  style={styles.selectStyle}>
              <Left>
              <Thumbnail small source={{uri: `https://ui-avatars.com/api/?format=png&name=CableTv&background=D5E6FB&color=2F80ED`}}  style={{  borderWidth: 1, borderColor: '#FFFFFF',marginLeft:10  }} />
                <Text style={{ fontSize: 14, color: '#4F4F4F', fontWeight: '600',marginLeft:10  }}>
                Cable Tv
                </Text>
              </Left>
              <Right>
              <Icon name="ios-arrow-dropright"  style={{   color: 'black' }} onPress={() => this.props.navigation.navigate("Biller")}/>
              </Right>
            </ListItem >

            <ListItem  style={styles.selectStyle}>
              <Left>
              <Thumbnail small source={{uri: `https://ui-avatars.com/api/?format=png&name=Utilities&background=D5E6FB&color=2F80ED`}}  style={{  borderWidth: 1, borderColor: '#FFFFFF',marginLeft:10  }} />
                <Text style={{ fontSize: 14, color: '#4F4F4F', fontWeight: '600',marginLeft:10  }}>
                Utilities
                </Text>
              </Left>
