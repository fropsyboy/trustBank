      ...
      <Container style={styles.container}>
        ...
        <Content >
          ...
          <View style={styles.buttonView} >
            <Button  block rounded style={styles.bottonStyle} onPress={() => this.props.navigation.navigate("Airtime")}>
                  <Text style={{color: 'white', textAlign: 'center',alignSelf: "center",}}>Airtime Payment</Text>
              </Button>   

              <Button  block rounded style={styles.bottonStyle} onPress={() => this.props.navigation.navigate("Billspay")}>
                  <Text style={{color: 'white', textAlign: 'center',alignSelf: "center",}}>Bills Payment</Text>
              </Button>   
          </View>
