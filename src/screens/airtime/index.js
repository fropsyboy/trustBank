    ...
    return (
      <Container style={styles.container}>
        <Header noShadow
            ...
            <Body>
            <Text style={{color: '#4F4F4F', fontSize: 18,fontWeight: '700',}}>Airtime</Text>
            </Body>
        ...
        <Content >
          ...
          <View style={{ marginRight:10, marginLeft:10, marginTop:15, alignSelf: "center"}}>
            ...
            <View style={{flexDirection: 'row', marginRight:10, marginLeft:10, marginTop:15, alignSelf: "center"}}>
                  <View style={{ width: 71, height: 88, backgroundColor: '#F2F2F2',borderRadius: 15, }}>
                    <Image style={{marginLeft:10, marginTop:10}} source={mtn}  />

                   
                  </View>

                  <View style={{ width: 71, height: 88, backgroundColor: '#F2F2F2',borderRadius: 15, marginLeft:10, }}>
                    <Image style={{marginLeft:10, marginTop:10}} source={airt}  />

                   
                  </View>
                  <View style={{ width: 71, height: 88, backgroundColor: '#F2F2F2',borderRadius: 15, marginLeft:10, }}>
                    <Image style={{marginLeft:10, marginTop:10}} source={eti}  />

                   
                  </View>
                  <View style={{ width: 71, height: 88, backgroundColor: '#F2F2F2',borderRadius: 15, marginLeft:10, }}>
                    <Image style={{marginLeft:0, marginTop:10}} source={glo}  />
              ...
              <Item regular style={styles.inputStyle}>
                <Input placeholder='Mobile Number' placeholderTextColor="#4F4F4F"  />
              </Item>
              ...
              <Button  block rounded style={styles.bottonStyle} onPress={() => this.props.navigation.navigate("Proceed")}>
