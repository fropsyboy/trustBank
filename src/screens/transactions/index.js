      ...
      <Container style={styles.container}>
        ...
        <Content >
          ...
          <View style={{ marginRight:10, marginLeft:10, marginTop:15, alignSelf: "center"}}>
              <View style={{ width: 304, height: 90, backgroundColor: '#FFFFFF',borderRadius: 15, }}>

              <Text style={{ fontSize: 14, color: '#BDBDBD', fontWeight: '600', textAlign: "center", textAlignVertical: "center", marginTop:10 }}>
                        Plan Balance{"\n"}
