      ...
      <Container style={styles.container}>
        ...
        <Content >
          ...
          <View style={styles.buttonView} >
            <Button  block rounded style={styles.bottonStyle} onPress={() => this.props.navigation.navigate("Transfer")}>
                  <Text style={{color: 'white', textAlign: 'center',alignSelf: "center",}}>Transfer to TrustBanc</Text>
              </Button>   

              <Button  block rounded style={styles.bottonStyle} onPress={() => this.props.navigation.navigate("Billspay")}>
                  <Text style={{color: 'white', textAlign: 'center',alignSelf: "center",}}>Transfer to Other Bank</Text>
              </Button>   
          </View>
