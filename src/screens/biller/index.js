      ...
      <Container style={styles.container}>
        ...
        <Item rounded style={styles.inputStyle}>
            ...
            <ListItem  style={styles.selectStyle}>
              <Left>
              <Thumbnail small source={{uri: `https://ui-avatars.com/api/?format=png&name=DSTV&background=D5E6FB&color=2F80ED`}}  style={{  borderWidth: 1, borderColor: '#FFFFFF',marginLeft:10  }} />
            ...
            <ListItem  style={styles.selectStyle}>
              <Left>
              <Thumbnail small source={{uri: `https://ui-avatars.com/api/?format=png&name=GOTV&background=D5E6FB&color=2F80ED`}}  style={{  borderWidth: 1, borderColor: '#FFFFFF',marginLeft:10  }} />
                <Text style={{ fontSize: 14, color: '#4F4F4F', fontWeight: '600',marginLeft:10  }}>
                GOTV
                </Text>
              </Left>
