  ...
  render() {
    return (
      <Container style={styles.container}>
        ...
        <View>
              <Text style={{ fontSize: 18, color: '#4F4F4F', fontWeight: '700',marginLeft:40  }}>
              TrustBanc Stash
              </Text>
              <Text style={{ fontSize: 18, color: '#4F4F4F', fontWeight: '400',marginLeft:40, marginTop:20  }}>
            ...
            <View style={{ marginRight:10, marginLeft:10, marginTop:15, alignSelf: "center"}}>
              <View style={{ width: 311, height: 89, backgroundColor: '#FF8700',borderRadius: 15,}}>

                  <Text style={{ fontSize: 18, color: '#FFFFFF', fontWeight: '700', marginTop:20, marginLeft:10   }} onPress={() => this.props.navigation.navigate("Stashamount")} >
                  How Frequent {"\n"}
                        <Text style={{ fontSize: 14, color: '#FFFFFF', fontWeight: '600', marginLeft:20 }} onPress={() => this.props.navigation.navigate("Stashamount")} >
                        Save your money anytime and anyhow you like.
                        </Text>
                        </Text>
                  </View>
            ...
            <View style={{ marginRight:10, marginLeft:10, marginTop:15, alignSelf: "center"}}>
              <View style={{ width: 304, height: 90, backgroundColor: '#095DC8',borderRadius: 15,}}>

                  <Text style={{ fontSize: 18, color: '#FFFFFF', fontWeight: '700', marginTop:20, marginLeft:10   }}>
                  How Frequent {"\n"}
                        <Text style={{ fontSize: 14, color: '#FFFFFF', fontWeight: '600', marginLeft:20 }}>
                        Save your money frequently or buy percentage.
                        </Text>
                        </Text>
                  </View>
