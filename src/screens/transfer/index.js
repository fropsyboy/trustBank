...
import { ImageBackground, View, Image, Modal, AsyncStorage, TouchableOpacity, ScrollView } from "react-native";
    ...
    return (
      <Container style={styles.container}>
        <Header noShadow
            ...
            <Body>
            <Text style={{color: '#4F4F4F', fontSize: 18,fontWeight: '700',}}>Transfer to TrustBanc</Text>
            </Body>
        ...
        <Content >
          ...
          <View style={{ marginRight:10, marginLeft:10, marginTop:15, alignSelf: "center"}}>
            ...
            <Text style={{ fontSize: 14, color: '#4F4F4F', fontWeight: '400',  marginTop:10, marginLeft: 20, }}>
          ...
          > 
          <View style={{flexDirection: 'row', marginRight:10, marginLeft:10, marginTop:15, alignSelf: "center"}}>
          <View style={{ width: 79, height: 97, backgroundColor: '#F2F2F2',borderRadius: 15, }}>
          <Thumbnail medium source={{uri: `https://ui-avatars.com/api/?format=png&name=AzeezAdebayou&background=E5E5E5&color=FF8700`}}  style={{  borderWidth: 1, borderColor: '#FFFFFF', alignSelf: "center",  }} />

          <Text style={{ fontSize: 10, color: '#4F4F4F', fontWeight: '400',  marginTop:10, textAlign: "center", textAlignVertical: "center", }}>
            Azzez A.
                </Text>  
          </View>

          <View style={{ width: 79, height: 97, backgroundColor: '#F2F2F2',borderRadius: 15, marginLeft: 10,}}>
          <Thumbnail medium source={{uri: `https://ui-avatars.com/api/?format=png&name=AzeezAdebayou&background=E5E5E5&color=FF8700`}}  style={{  borderWidth: 1, borderColor: '#FFFFFF', alignSelf: "center",  }} />
          ...
          <Text style={{ fontSize: 10, color: '#4F4F4F', fontWeight: '400',  marginTop:10, textAlign: "center", textAlignVertical: "center", }}>
            Azzez A.
              ...
              <Item regular style={styles.inputStyle}>
                <Input placeholder='Bank' placeholderTextColor="#4F4F4F"  />
              </Item>

              <Item regular style={styles.inputStyle}>
                <Input placeholder='Beneficiary Account Number' placeholderTextColor="#4F4F4F"  />
              </Item>
              ...
              <Text style={{ fontSize: 14, color: '#000000', fontWeight: '400',  marginTop:10, marginLeft: 20, }}>
                    Daily Transaction Limit: 
                        <Text style={{ fontSize: 14, color: '#FF8700', fontWeight: '600', textAlign: "center", textAlignVertical: "center" }}>
                        ₦1,000,000
                        </Text>
                        </Text>
           <Item regular style={styles.inputStyle}>
                <Input placeholder='Naration' placeholderTextColor="#4F4F4F"  />
              </Item>

              <Button  block rounded style={styles.bottonStyle} onPress={() => this.props.navigation.navigate("Proceedt")}>
                  <Text style={{color: 'white', textAlign: 'center',alignSelf: "center",}}>Proceed</Text>
              </Button>         
