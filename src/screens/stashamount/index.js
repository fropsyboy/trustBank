...
class Stashamount extends Component {
    ...
    return (
      <Container style={styles.container}>
        ...
        <View>
            ...
            <Label>Enter Stash Amount</Label>
                <Input placeholderTextColor="#828282"  />
              </Item>

              <Item floatingLabel  style={styles.inputStyle}>
              <Label>Enter Stash Name</Label>
                <Input  placeholderTextColor="#828282"  />
              </Item>


              <Item floatingLabel style={styles.inputStyle}>
              <Label>Enter Stash Category</Label>
                <Input  placeholderTextColor="#828282"  />
              </Item>
            ...
            <Button  block rounded style={styles.bottonStyle} >
                  <Text style={{color: 'white', textAlign: 'center',alignSelf: "center",}}>Create Stash</Text>
              </Button>    
