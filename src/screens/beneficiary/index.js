    ...
    return (
      <Container style={styles.container}>
        <Header noShadow
            ...
            <Body>
            <Text style={{color: '#4F4F4F', fontSize: 18,fontWeight: '700',}}>Beneficiaries</Text>
            </Body>
            <Right>
            <Icon name="ios-add-circle-outline" style={{ color: "#2F80ED" }} onPress={() => this.props.navigation.navigate("Addbeneficiary")}/>
            </Right>
            </Header>
        ...
        <Item rounded style={styles.inputStyle}>
            ...
            <ListItem  style={styles.selectStyle}>
              <Left>
              <Thumbnail small source={{uri: `https://ui-avatars.com/api/?format=png&name=AzeezAdebayou&background=D5E6FB&color=2F80ED`}}  style={{  borderWidth: 1, borderColor: '#FFFFFF',marginLeft:10  }} />
