...
import SetBVN from "./screens/setBVN";
import ConfirmBVN from "./screens/confirmBVN";
import SetAddress from "./screens/setAddress";
import SetTPin from "./screens/setTPin";
import SignDetailsA from "./screens/signDetailsA";
import SignDetailsB from "./screens/signDetailsB";
...
import Anb from "./screens/anb";
import Billspay from "./screens/billspay";
import Biller from "./screens/biller";
import Transactions from "./screens/transactions";
import Anbt from "./screens/anbt";
import Transfer from "./screens/transfer";
import Proceed from "./screens/proceed";
import Proceedt from "./screens/proceedt";
import Stash from "./screens/stash";
import Anbs from "./screens/anbs";
import Stashamount from "./screens/stashamount";
...
const AppNavigator = createStackNavigator(
  {
    ...
    SetBVN: { screen: SetBVN },
    ConfirmBVN: { screen: ConfirmBVN },
    SetAddress: { screen: SetAddress },
    SetTPin: { screen: SetTPin },
    SignDetailsA: { screen: SignDetailsA },
    SignDetailsB: { screen: SignDetailsB },
    Flash: { screen: Flash },
    ...
    Addbeneficiary: { screen: Addbeneficiary },
    Airtime: { screen: Airtime },
    Anb: { screen: Anb },
    Billspay: { screen: Billspay },
    Biller: { screen: Biller },
    Transactions: { screen: Transactions },
    Anbt: { screen: Anbt },
    Transfer: { screen: Transfer },
    Proceed: { screen: Proceed },
    Proceedt: { screen: Proceedt },
    Stash: { screen: Stash },
    Anbs: { screen: Anbs },
    Stashamount: { screen: Stashamount },
